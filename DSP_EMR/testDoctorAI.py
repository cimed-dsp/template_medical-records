...
inputs:
	- .npz model file (use higest number for best model) from doctorAI.py
	- visit file, Use "<whatever file name>_seqs_visit.test" from process_mimic
	- label file, Use "<whatever file name>_seqs_label.test" from process_mimic
	- hidden dimension size from doctorAI.py.  Default was "[200,200]"
	-  (optional) output file name. 

outputs:
	- if output file name provided, will save a pickled dict of:
		{'inputs':[[input codes]...], 
...
def parse_arguments(parser):
	...
	parser.add_argument('--output_file', type=str, default='', help='The name of the output file with predicted codes generated from model.  If you do not want to evaluate the results at that level, do not use this option')
